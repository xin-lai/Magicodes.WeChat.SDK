...
//          All rights reserved
//  
//          filename : WeiChatApisContext.cs
//          description :
//  
...
namespace Magicodes.WeChat.SDK
{
    ...
    ///     接口上下文对象
    /// </summary>
    public class WeiChatApisContext
    {
        private static readonly Lazy<WeiChatApisContext> Lazy = new Lazy<WeiChatApisContext>(() => new WeiChatApisContext());
        public static WeiChatApisContext Current => Lazy.Value;
        /// <summary>
        /// 访问凭据存储
        /// </summary>
        internal ConcurrentDictionary<string, TokenApiResult> AccessTokenConcurrentDictionary =new ConcurrentDictionary<string, TokenApiResult>();
        internal ConcurrentDictionary<string, TicketApiResult> TicketConcurrentDictionary = new ConcurrentDictionary<string, TicketApiResult>();
        /// <summary>
        ///     凭据管理接口
        /// </summary>
