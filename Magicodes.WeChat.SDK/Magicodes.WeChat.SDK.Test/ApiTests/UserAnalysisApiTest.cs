...
//          All rights reserved
//  
//          filename : UserAnalysisApiTest.cs
//          description :
//  
...
namespace Magicodes.WeChat.SDK.Test.ApiTests
{
    ...
    public class UserAnalysisApiTest : ApiTestBase
    {
        ...
        {
            var begin_date = DateTime.Now.AddDays(-3);
            var end_date = DateTime.Now.AddDays(-1);
        ...
        {
            var begin_date = DateTime.Now.AddDays(-7);
            var end_date = DateTime.Now.AddDays(-1);
        ...
        public void GetUpstreammsghourApiTest_CURD()
        {
            var begin_date = DateTime.Now.AddDays(-1);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsghour = api.GetStatisticsInfo<UpstreammsghourResult>(begin_date, end_date,
                "getupstreammsghour");
        ...
        public void GetUpstreammsgweekApiTest_CURD()
        {
            var begin_date = DateTime.Now.AddDays(-7);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsgweek = api.GetStatisticsInfo<UpstreammsgweekResult>(begin_date, end_date,
                "getupstreammsgweek");
        ...
        {
            var begin_date = DateTime.Now.AddDays(-30);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsgmonth = api.GetStatisticsInfo<UpstreammsgmonthResult>(begin_date, end_date,
                "getupstreammsgmonth");
        ...
        {
            var begin_date = DateTime.Now.AddDays(-15);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsgdist = api.GetStatisticsInfo<UpstreammsgdistApiResult>(begin_date, end_date,
                "getupstreammsgdist");
        ...
        public void GetUpstreammsgdistweekApiTest_CURD()
        {
            var begin_date = DateTime.Now.AddDays(-30);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsgdistweek = api.GetStatisticsInfo<UpstreammsgdistWeekApiResult>(begin_date, end_date,
        ...
        public void GetUpstreammsgdistmonthApiTest_CURD()
        {
            var begin_date = DateTime.Now.AddDays(-30);
            var end_date = DateTime.Now.AddDays(-1);
            var getupstreammsgdistmonth = api.GetStatisticsInfo<UpstreammsgdistmonthApiResult>(begin_date, end_date,
